...
class Team:
    ...
    @property
    def points(self):
        return self.won * Team.WIN_POINTS + self.drawn * Team.DRAW_POINTS
    ...
    def league_numbers(self):
        return (self.name, self.played, self.won, self.drawn, self.lost, 
                self.scored, self.conceded, self.difference, self.points,)
