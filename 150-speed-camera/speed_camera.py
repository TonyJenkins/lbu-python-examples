...
def initialise_speed_lists():
    return {type: [] for type in VEHICLE_TYPES}
...
def get_total_speeder_percent(speeds):
    ...
    total_speeders = count_vehicle_type_speeders(speeds, 'C', SPEED_LIMITS['C']) + \
...
def analyse_and_print_results(speeds):
    ...
    print()
    print(f'Speeding Cars: {count_vehicle_type_speeders(speeds, 'C', SPEED_LIMITS['C'])}'
          f' of {count_vehicle_type(speeds, 'C')}')
    print(f'Speeding Vans: {count_vehicle_type_speeders(speeds, 'V', SPEED_LIMITS['V'])}'
          f' of {count_vehicle_type(speeds, 'V')}')
    print(f'Speeding Buses: {count_vehicle_type_speeders(speeds, 'B', SPEED_LIMITS['B'])}'
          f' of {count_vehicle_type(speeds, 'B')}')
    print(f'Speeding HGVs: {count_vehicle_type_speeders(speeds, 'H', SPEED_LIMITS['H'])}'
